...
/**
 * Each step of the clear signing interpretation process.
 * Used by the UI to display the progressive analysis.
 */
export type InterpretationStep =
  | {
      kind: "spec-match";
      contractAddress: string;
      matchedSpec: IntentSpec | null;
    }
  | {
      kind: "function-id";
      selector: string;
